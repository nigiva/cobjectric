...
By default, `list[BaseModel]` fields are compared pairwise (by index). However, you can use different comparison strategies for better alignment when list order may differ.
